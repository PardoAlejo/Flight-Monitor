...
class SQLiteStorage:
    ...
    def get_price_stats(
        ...
        """
        Get price statistics for a route, including average of LOW (best) prices.
        ...
        Returns:
            PriceStats with average LOW price, min price, and count
        """
        with self._get_connection() as conn:
            # Get average of "best" (LOW) category prices
        ...
        avg_low = row_avg[0] if row_avg and row_avg[0] else None
        count_low = row_avg[1] if row_avg else 0
